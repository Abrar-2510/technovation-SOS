...
import 'package:todo_list/pages/main/search_page.dart';
...
class MainPage extends StatelessWidget {
  Widget build(BuildContext context) {
    ...
    final Uri _url = Uri.parse('https://www.kommunicate.io/livechat-demo?appId=cbe20be2f3d3128c7ac0002f61f435d6&botIds=wellbe-tpzc3&assignee=wellbe-tpzc3');
                ...
                children: <Widget>[
                  Container(
                    child: RaisedButton(
                      ...
                      child: Text('Take your assessment!'),
                    ),
                  ),
                  Opacity(
